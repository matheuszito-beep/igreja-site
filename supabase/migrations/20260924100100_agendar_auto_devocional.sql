-- Chama a função auto-devocional todo dia às 6h de Brasília (9h UTC).
...
-- regras de RLS da migração de devocionais.
select cron.schedule(
  'auto-devocional',
  '0 9 * * *',
  $$
  select net.http_post(
    url := 'https://htwckbwlhdesdkgdtwle.supabase.co/functions/v1/auto-devocional',
